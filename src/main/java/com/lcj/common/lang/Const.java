package com.lcj.common.lang;

public class Const {
    public final static String CAPTCHA_KEY = "captcha";
    public final static String DEFAULT_PASSWORD = "666666";
    public final static String IMG_PATH =  "http://localhost:8081/img";  //图片存储路径
    public final static String DEFAULT_IMG = "http://localhost:8081/img/2023/3/defalut.jpg";
